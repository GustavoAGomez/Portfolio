...
export function Statement() {
  ...
  if (content) {
    return (
      <div className="min-h-svh flex flex-col items-center justify-center px-6 text-center pointer-events-none">
        ...
        <h1 ref={line} className="font-display uppercase tracking-tight text-white text-[14vw] md:text-[min(10vw,9rem)]" style={{ lineHeight: 1 }}>
  ...
  return (
    <div className="min-h-svh flex items-center justify-center px-6 pointer-events-none">
      <h1 ref={line} className="font-display text-center text-[13vw] md:text-[min(9vw,8.1rem)]" style={{ lineHeight: 1 }}>
