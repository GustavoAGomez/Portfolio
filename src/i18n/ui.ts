 ...
 * source copy. Labels that are brand-English in the Spanish site (Selected
 * Work, Scroll, ← Index, the HUD links) are identical in both and stay out of
 * this file. `useT()` is reactive: switching locale re-renders consumers.
 */
const UI = {
  es: {
    // Case study
